       ...
       <div class="container">
            ...
            <div class="w3-container">
                <ul class="w3-navbar w3-light-grey">
                    ...
                    <li><a class="active" href="fetchmanagementteam.php">Management team</a></li>
...
<div class="container consultbox">
  <div class="row ">
    ...
    <h2> Here are our Management team</h2>
    </div>
    <div class="row">
...
$sql = "SELECT * from managementteam";
$result = mysqli_query($conn , $sql);

while($row = mysqli_fetch_array($result,MYSQLI_NUM)){
    
        echo "<div class='col-sm-3 abc'>";   
        echo "<img src=images/managementteamphoto/{$row['2']} id ='image'>";
        echo "<div class ='overlay'>";
        echo "<div class='text'>Name:{$row['1']}<br> Postion:{$row['6']} <br> Phone:{$row['7']} <br> Email:{$row['8']}";
        echo "</div>";
        echo "</div>";
        echo "</div>";
